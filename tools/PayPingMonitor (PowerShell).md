...
1. **Create the Script File:**
    ...
    - Paste the provided PowerShell code into this file and save it. [Code](https://github.com/paymanafshari021/Pay_Fortinet_Note/blob/main/tools/PayPingMonitor%20\(PowerShell\).md#code)
2. **Run the Monitor:**
